...
public class YellowLavaCauldronBlock extends AbstractCauldronBlock {

    public YellowLavaCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.YELLOW_LAVA_CAULDRON_BEHAVIOR);
    }
