...
public class GrayLavaCauldronBlock extends AbstractCauldronBlock {

    public GrayLavaCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.GRAY_LAVA_CAULDRON_BEHAVIOR);
    }
