...
public class BlackLavaCauldronBlock extends AbstractCauldronBlock {

    public BlackLavaCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.BLACK_LAVA_CAULDRON_BEHAVIOR);
    }
