...
public class PinkWaterCauldronBlock extends AbstractCauldronBlock {

    public PinkWaterCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.PINK_WATER_CAULDRON_BEHAVIOR);
    }
