...
import net.spacegateir.dyeableliquids.block.fluidblocks.ModFluidBlack;
...
public abstract class BlackLavaFluid extends FlowableFluid {
    public static final float MIN_HEIGHT_TO_REPLACE = 0.44444445F;

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_BLACK_LAVA;
    }

    @Override
    public Fluid getStill() {
        return ModFluids.STILL_BLACK_LAVA;
    }

    @Override
    public Item getBucketItem() {
        return ModItems.BLACK_LAVA_BUCKET;
    }
    ...
    protected void flow(WorldAccess world, BlockPos pos, BlockState state, Direction direction, FluidState fluidState) {
        ...
        // BLACK_LAVA + BLACK_WATER => BLACK_CONCRETE
    ...
    public BlockState toBlockState(FluidState state) {
        return ModFluids.BLACK_LAVA_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Still extends BlackLavaFluid {
        @Override
        public int getLevel(FluidState state) {
            return 8;
        }
