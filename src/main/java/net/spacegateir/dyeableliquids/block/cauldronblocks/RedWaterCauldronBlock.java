...
public class RedWaterCauldronBlock extends AbstractCauldronBlock {

    public RedWaterCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.RED_WATER_CAULDRON_BEHAVIOR);
    }
