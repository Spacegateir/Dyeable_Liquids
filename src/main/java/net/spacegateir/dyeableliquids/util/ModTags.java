...
public class ModTags {
    public static class Blocks {
        ...
        private static TagKey<Block> createBlockTag(String name) {
            return TagKey.of(RegistryKeys.BLOCK, new Identifier(DyeableLiquids.MOD_ID, name));
        }
    ...
    public static class Items {
        ...
        private static TagKey<Item> createItemTag(String name) {
            return TagKey.of(RegistryKeys.ITEM, new Identifier(DyeableLiquids.MOD_ID, name));
        }
    ...
    public static class Fluids {
        ...
        public static final TagKey<Fluid> LAVA_DL = createFluidTag("white_lava_dl");
        ...
        public static final TagKey<Fluid> WATER_DL = createFluidTag("white_water_dl");
        ...
        private static TagKey<Fluid> createFluidTag(String name) {
            return TagKey.of(RegistryKeys.FLUID, new Identifier(DyeableLiquids.MOD_ID, name));
        }
