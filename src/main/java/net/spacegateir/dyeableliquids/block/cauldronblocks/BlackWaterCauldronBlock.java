...
public class BlackWaterCauldronBlock extends AbstractCauldronBlock {

    public BlackWaterCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.BLACK_WATER_CAULDRON_BEHAVIOR);
    }
