...
public class BrownLavaCauldronBlock extends AbstractCauldronBlock {

    public BrownLavaCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.BROWN_LAVA_CAULDRON_BEHAVIOR);
    }
