...
public abstract class MagentaWaterFluid extends FlowableFluid {
    @Override
    ...
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.MAGENTA_WATER_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
