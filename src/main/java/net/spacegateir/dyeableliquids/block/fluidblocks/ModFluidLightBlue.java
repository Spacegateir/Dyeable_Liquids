package net.spacegateir.dyeableliquids.block.fluidblocks;
...
public class ModFluidLightBlue extends Block implements FluidDrainable {
    ...
    public ModFluidLightBlue(FlowableFluid fluid, Settings settings) {
        super(settings);
        this.fluid = fluid;
