...
public abstract class LightBlueWaterFluid extends FlowableFluid {
    @Override
    ...
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.LIGHT_BLUE_WATER_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
