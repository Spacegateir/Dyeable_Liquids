...
public class PurpleLavaCauldronBlock extends AbstractCauldronBlock {

    public PurpleLavaCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.PURPLE_LAVA_CAULDRON_BEHAVIOR);
    }
