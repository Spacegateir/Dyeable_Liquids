...
public class GreenWaterCauldronBlock extends AbstractCauldronBlock {

    public GreenWaterCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.GREEN_WATER_CAULDRON_BEHAVIOR);
    }
