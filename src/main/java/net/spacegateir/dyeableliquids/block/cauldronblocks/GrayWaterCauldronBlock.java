...
public class GrayWaterCauldronBlock extends AbstractCauldronBlock {

    public GrayWaterCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.GRAY_WATER_CAULDRON_BEHAVIOR);
    }
