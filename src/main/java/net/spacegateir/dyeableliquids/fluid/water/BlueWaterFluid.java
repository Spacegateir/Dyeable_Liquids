...
public abstract class BlueWaterFluid extends FlowableFluid {
    @Override
    ...
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.BLUE_WATER_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
