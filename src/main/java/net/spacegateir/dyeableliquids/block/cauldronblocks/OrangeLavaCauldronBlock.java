...
public class OrangeLavaCauldronBlock extends AbstractCauldronBlock {

    public OrangeLavaCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.ORANGE_LAVA_CAULDRON_BEHAVIOR);
    }
