...
public class LimeWaterCauldronBlock extends AbstractCauldronBlock {

    public LimeWaterCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.LIME_WATER_CAULDRON_BEHAVIOR);
    }
