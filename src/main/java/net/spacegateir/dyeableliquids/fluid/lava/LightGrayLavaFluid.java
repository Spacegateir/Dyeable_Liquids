...
import net.spacegateir.dyeableliquids.block.fluidblocks.ModFluidLightGray;
...
public abstract class LightGrayLavaFluid extends FlowableFluid {
    public static final float MIN_HEIGHT_TO_REPLACE = 0.44444445F;

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_LIGHT_GRAY_LAVA;
    }

    @Override
    public Fluid getStill() {
        return ModFluids.STILL_LIGHT_GRAY_LAVA;
    }

    @Override
    public Item getBucketItem() {
        return ModItems.LIGHT_GRAY_LAVA_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return ModFluids.LIGHT_GRAY_LAVA_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }

    public static class Flowing extends LightGrayLavaFluid {
        @Override
    ...
    public static class Still extends LightGrayLavaFluid {
        @Override
        public int getLevel(FluidState state) {
            return 8;
        }
