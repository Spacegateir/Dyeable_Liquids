...
public class CyanLavaCauldronBlock extends AbstractCauldronBlock {

    public CyanLavaCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.CYAN_LAVA_CAULDRON_BEHAVIOR);
    }
