...
public class LimeLavaCauldronBlock extends AbstractCauldronBlock {

    public LimeLavaCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.LIME_LAVA_CAULDRON_BEHAVIOR);
    }
