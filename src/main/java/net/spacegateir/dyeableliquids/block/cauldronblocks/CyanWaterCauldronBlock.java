...
public class CyanWaterCauldronBlock extends AbstractCauldronBlock {

    public CyanWaterCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.CYAN_WATER_CAULDRON_BEHAVIOR);
    }
