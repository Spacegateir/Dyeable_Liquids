...
public class GreenLavaCauldronBlock extends AbstractCauldronBlock {

    public GreenLavaCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.GREEN_LAVA_CAULDRON_BEHAVIOR);
    }
