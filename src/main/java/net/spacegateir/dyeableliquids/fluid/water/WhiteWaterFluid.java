...
public abstract class WhiteWaterFluid extends FlowableFluid {
    @Override
    ...
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.WHITE_WATER_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
