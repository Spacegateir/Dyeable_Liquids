...
public abstract class CyanWaterFluid extends FlowableFluid {
    @Override
    ...
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.CYAN_WATER_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
