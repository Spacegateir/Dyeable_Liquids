...
public class BrownWaterCauldronBlock extends AbstractCauldronBlock {

    public BrownWaterCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.BROWN_WATER_CAULDRON_BEHAVIOR);
    }
