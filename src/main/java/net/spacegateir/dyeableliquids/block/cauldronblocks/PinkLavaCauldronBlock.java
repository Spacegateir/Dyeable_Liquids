...
public class PinkLavaCauldronBlock extends AbstractCauldronBlock {

    public PinkLavaCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.PINK_LAVA_CAULDRON_BEHAVIOR);
    }
