...
public class WhiteWaterCauldronBlock extends AbstractCauldronBlock {

    public WhiteWaterCauldronBlock(Settings settings) {
        super(settings, ModCauldronInteractions.WHITE_WATER_CAULDRON_BEHAVIOR);
    }
