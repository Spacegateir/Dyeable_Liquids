...
import net.spacegateir.dyeableliquids.block.fluidblocks.ModFluidOrange;
...
public abstract class OrangeLavaFluid extends FlowableFluid {
    ...
    public Fluid getFlowing() {
        return ModFluids.FLOWING_ORANGE_LAVA;
    }

    @Override
    public Fluid getStill() {
        return ModFluids.STILL_ORANGE_LAVA;
    }

    @Override
    public Item getBucketItem() {
        return ModItems.ORANGE_LAVA_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return ModFluids.ORANGE_LAVA_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }

    // Subclasses

    public static class Flowing extends OrangeLavaFluid {
        @Override
    ...
    public static class Still extends OrangeLavaFluid {
        @Override
        public int getLevel(FluidState state) {
            return 8;
        }
